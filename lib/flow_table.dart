      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          onPanUpdate: (details) {
            ...
            double newLeftWidth =
                widget.columnWidths[index] * totalWidth + details.delta.dx;
            double newRightWidth =
                widget.columnWidths[index + 1] * totalWidth - details.delta.dx;

            // Only update if both columns would remain wider than minimum
            if (newLeftWidth >= FlowTable.minColumnWidth &&
                newRightWidth >= FlowTable.minColumnWidth) {
              ...
              Expanded(
                child: Scrollbar(
                  ...
                  child: ListView.builder(
                    controller: widget.controller,
                    itemCount: (FlowTable.totalItems + 5) ~/ 6,
                    cacheExtent: 1000,
                    itemExtent: 25,
